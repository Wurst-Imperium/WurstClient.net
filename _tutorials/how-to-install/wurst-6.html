		...
		<div class="grid no-margin">
			<div class="row cells2">
				<div class="cell align-center">
                  ...
                  <img src="https://images.wurstclient.net/_media/zip_file.webp" alt="windows zip file icon" title="These icons are just for decoration. Your icon might look different and that's OK. It's the extension (.zip/.jar) that counts!">
                  <br>
				...
				<div class="cell align-center">
                  ...
                  <img src="https://images.wurstclient.net/_media/jar_file.webp" alt="java jar file icon" title="These icons are just for decoration. Your icon might look different and that's OK. It's the extension (.zip/.jar) that counts!">
                  <br>
...
<article class="padding60 no-padding-left no-padding-right" id="zip">
	<div class="container">
        ...
        <ol class="step-list">
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_extract_zip.webp" alt="how to extract a zip file with 7zip">
               </p>
               <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_run_installer_cmd.webp" alt="how to run a cmd file">
               </p>
               <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_press_install.webp" alt="the 'install' button of the Wurst 6 installer">
               </p>
               <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_success_message.webp" alt="the 'success' message of the Wurst 6 installer">
               </p>
               <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_press_play_old.webp" alt="how to press 'play' in the Minecraft launcher">
               </p>
               <p>
...
<article class="padding60 no-padding-left no-padding-right bg-grayLighter" id="jar">
	<div class="container">
        ...
        <ol class="step-list">
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_wurst_6_run_with_java.webp" alt="how to run the Wurst 6 installer with Java">
               </p>
               <p>
...
<article class="padding60 no-padding-left no-padding-right" id="download_through_launcher">
	<div class="container">
        ...
        <ol class="step-list">
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_error_couldnt_find_minecraft.webp" alt="Error message in the Wurst 6 installer: 'Couldn't find Minecarft 1.12 at: C:\Users\...\AppData\Roaming\.minecraft\versions\1.12\1.12.jar Please download Minecarft 1.12 through the launcher and try again. [OK]'">
               </p>
               <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_create_new_profile.webp" alt="how to create a new profile (or 'installation') in the Minecraft launcher">
               </p>
               <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_select_profile_version.webp" alt="how to change the version of a Minecraft launcher profile">
               </p>
               <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_launch_1.12.webp" alt="Launching an unnamed Minecraft 1.12 installation">
               </p>
               <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_safety_nonsense_1.12.webp" alt="Mojang's player safety nonsense">
               </p>
                <p>
            ...
            <li>
               <p>
                  <img src="https://images.wurstclient.net/_media/install_downloading_minecraft.webp" alt="downloading Minecraft 1.12 through the launcher">
               </p>
               <p>
