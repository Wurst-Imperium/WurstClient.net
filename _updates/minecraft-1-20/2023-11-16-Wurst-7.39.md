...
- Fixed TreeBot being completely unaware of mangrove trees, cherry trees, and both types of nether trees (huge warped/crimson fungus). TreeBot still won't be able to chop most of these trees due to their large size, but at least it can now see them and pathfind through their leaves.
