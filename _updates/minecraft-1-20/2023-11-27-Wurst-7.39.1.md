...
For now, I'm releasing a new version that does this one part of AutoBuild in a slightly different way, so that BitDefender will stop complaining about it. But for a more long-term solution, let's all [report this issue to BitDefender](https://www.bitdefender.com/consumer/support/answer/29358/) so they'll fix the false positive on their end too.
