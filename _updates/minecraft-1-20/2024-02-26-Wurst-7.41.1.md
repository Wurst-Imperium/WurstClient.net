...
- This update was initially released for Minecraft 1.20.4 and 1.20.2, then backported to 1.20.1. Backports to other Minecraft 1.20.x versions are currently in progress.
