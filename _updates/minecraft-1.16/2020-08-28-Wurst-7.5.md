---
title: Wurst 7.5 - Better Entity Filters, Bugfixes, 1.16.3 Support
...
- BowAimbot, ClickAura, FightBot, [Killaura](https://wiki.wurstclient.net/killaura), KillauraLegit, MultiAura, Protect, TP-Aura and TriggerBot can now target end crystals.

- Added a "Filter end crystals" checkbox to BowAimbot, ClickAura, FightBot, [Killaura](https://wiki.wurstclient.net/killaura), KillauraLegit, MultiAura, Protect, TP-Aura and TriggerBot.
...
1. **Download Wurst** (see the [download buttons](#downloads) below).

1. **Download the Fabric API** (linked next to the [download buttons](#downloads)).
