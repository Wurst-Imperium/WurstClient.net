...
- Added a "show totem counter" checkbox to <a href="https://wiki.wurstclient.net/hack/autototem">AutoTotem</a>. When checked, AutoTotem will display the number of totems you have in the HackList.
