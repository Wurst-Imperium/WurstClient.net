---
title: Wurst 7.6.2 - More Bugfixes, 1.16.4 Support
...
minecraft-versions:
  ...
  - "1.16.4-pre2"
fabric: true
image: https://wiki.wurstclient.net/_media/update/wurst_7.6.2_540p.webp
fabric-api:
  "1.16.4": https://github.com/FabricMC/fabric/releases/tag/0.25.1%2Bbuild.416-1.16
...
other:
  ...
  - Zoom
---
This version of the Wurst Hacked Client is available for Minecraft 1.16.4, 1.16.3, 1.16.2, 1.16.1 and 1.15.2, as well as pre-release 1.16.4-pre2 and release candidate 1.16.4-rc1.
...
- Navigator's search bar will now find [MountBypass](https://wiki.wurstclient.net/mountbypass) when searching for "AutoMount" or "auto mount".
