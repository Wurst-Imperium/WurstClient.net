...
- [AntiSpam](https://wiki.wurstclient.net/antispam) is back!
...
- Fixed [X-Ray](https://wiki.wurstclient.net/x-ray)'s default list of ores not loading properly in 1.15 snapshots.
