...
fabric-api:
  ...
  1.15-pre2: 0.4.15+build.267-1.15
  1.15-pre1: 0.4.13+build.263-1.15
  1.14_combat-3: 0.4.1+build.245-1.14
---
## Changelog
...
{% include update/features.html hacks=site.data.hacks.since_v7_0pre17 commands=site.data.commands.since_v7_0pre16 other=site.data.other_features.since_v7_0pre16 %}
