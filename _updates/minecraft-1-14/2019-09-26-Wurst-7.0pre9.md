---
title: Wurst 7.0pre9 - Search Hack, Taco, 19w38b
...
- This version of Wurst is available for Minecraft 1.14.4 and 19w38b.
...
1. **Run the Fabric installer** as follows:
   ...
   Minecraft Version: <kbd>1.14.4</kbd> or <kbd>19w38b</kbd>  
   Show snapshots: Yes  
   Loader Version: <kbd>0.6.2+build.166</kbd>  
   Select Install Location: (leave it at the default)  
   Create profile: (leave it enabled)

1. **Download the Fabric API** (<a href="https://www.curseforge.com/minecraft/mc-mods/fabric-api/files/2791092" target="_blank" rel="nofollow">for 1.14.4</a>) (<a href="https://www.curseforge.com/minecraft/mc-mods/fabric-api/files/2794490" target="_blank" rel="nofollow">for 19w38b</a>).
