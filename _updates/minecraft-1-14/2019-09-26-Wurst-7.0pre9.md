...
- [Search](https://wiki.wurstclient.net/search) is back!

- Added a ["Block" setting](https://wiki.wurstclient.net/search#block) to Search that determines the type of block to search for. (`.search` will not be added back, as this setting makes it obsolete.)
