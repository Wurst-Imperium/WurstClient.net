...
- ~~Fixed MobSpawnESP sometimes causing the game to crash.~~ Unfortunately this fix is not working properly. It _should_ be fixed in v7.0pre2.
...
**Note:** If you can't open the ClickGUI by pressing Right CTRL, try using the following command (in the Minecraft chat): <code>.binds<nbsp>reset</code>

Navigator and TabGUI will be added back in later pre-releases.
