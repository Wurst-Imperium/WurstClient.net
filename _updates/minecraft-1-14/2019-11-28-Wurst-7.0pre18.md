...
fabric-api:
  "1.15": 0.4.23+build.276-1.15
  1.14.4: 0.4.1+build.245-1.14
  1.15.1-pre1: 0.4.23+build.276-1.15
  1.15-pre7: 0.4.20+build.273-1.15
  1.15-pre6: 0.4.20+build.273-1.15
  1.15-pre5: 0.4.20+build.273-1.15
  1.15-pre4: 0.4.18+build.271-1.15
  1.15-pre3: 0.4.18+build.271-1.15
---
## Changelog
