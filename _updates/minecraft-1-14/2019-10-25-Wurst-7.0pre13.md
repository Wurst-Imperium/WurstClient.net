...
minecraft-versions:
  ...
  - "1.14.2"
fabric: true
image: https://wiki.wurstclient.net/_media/update/wurst_7.0pre13_540p.webp
hacks:
   - AntiCactus
   - AutoMine
   - AutoRespawn
...
- [`.friends`](https://wiki.wurstclient.net/cmd/friends) is back! (thanks to <a href="https://github.com/Mersid" target="_blank" rel="nofollow">@Mersid</a>)

- Added [`.friends remove-all`](https://wiki.wurstclient.net/cmd/friends).

- The "Click Friends" setting in the Wurst Options is back!

- Added a "Middle click friends" checkbox to [`.friends`](https://wiki.wurstclient.net/cmd/friends) (you can only see this by using [Navigator](https://wiki.wurstclient.net/navigator)). Does the same thing as the button in the Wurst Options.
