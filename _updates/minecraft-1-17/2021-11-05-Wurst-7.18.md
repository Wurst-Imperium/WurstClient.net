...
other:
  ...
  - Zoom
---
**While this version is technically not yet available for Minecraft 1.18, it probably already works with it.** Once Minecraft 1.18 is released you can simply set your Fabric installer to 1.18, but then put Wurst & Fabric API for the latest 1.18 pre-release in your mods folder.
