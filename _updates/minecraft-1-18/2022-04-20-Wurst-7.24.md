...
- Fixed a crash when using Fabric API v0.51.0 or newer. ([#625](https://github.com/Wurst-Imperium/Wurst7/issues/625))

- Added [InvWalk](https://wurst.wiki/invwalk) settings to disable the sneak, sprint, and jump keys.

- Added Romanian translations for 164 strings. ([#626](https://github.com/Wurst-Imperium/Wurst7/pull/626) - Thanks to <a href="https://github.com/Drajbonel">Drajbonel</a>!)
