...
- Added [InvWalk](https://wurst.wiki/invwalk): Allows you to move around while the inventory is open. ([#414](https://github.com/Wurst-Imperium/Wurst7/pull/414) - Thanks to <a href="https://github.com/TheWienerMaster">TheWienerMaster</a>!)
...
- Added a "Damage indicator" checkbox to [Killaura](https://wurst.wiki/killaura) and [KillauraLegit](https://wurst.wiki/killauralegit). Allows you to turn off the damage indicator. ([#618](https://github.com/Wurst-Imperium/Wurst7/pull/618) - Thanks to <a href="https://github.com/sudofox">sudofox</a>!)

- Added Japanese translations for 20 strings and changed translations for 137 strings. ([#606](https://github.com/Wurst-Imperium/Wurst7/pull/606), [#612](https://github.com/Wurst-Imperium/Wurst7/pull/612) - Thanks to skidderrom and yuta2312!)

- Added Polish translations for 3 strings. ([#613](https://github.com/Wurst-Imperium/Wurst7/pull/613) - Thanks to <a href="https://github.com/ZANX3Y">ZANX3Y</a>!)

- Changed Russian translations for 6 strings. ([#572](https://github.com/Wurst-Imperium/Wurst7/pull/572) - Thanks to <a href="https://github.com/ti-bone">ti-bone</a>!)

- Changed Chinese (Simplified/Mainland) translations for 1 string. ([#617](https://github.com/Wurst-Imperium/Wurst7/pull/617) - Thanks to <a href="https://github.com/MineYuanlu">MineYuanlu</a>!)
