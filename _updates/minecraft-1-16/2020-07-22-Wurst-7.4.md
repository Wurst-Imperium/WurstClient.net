...
fabric-api:
  1.16.2: 0.17.2+build.396-1.16
  1.16.1: 0.14.0+build.371-1.16
  1.15.2: 0.14.0+build.317-1.15
  1.14.4: 0.14.0+build.258-1.14
  1.16.2-rc2: 0.17.1+build.394-1.16
  1.16.2-rc1: 0.17.1+build.394-1.16
  1.16.2-pre3: 0.16.4+build.392-1.16
  1.16.2-pre2: 0.16.4+build.392-1.16
  1.16.2-pre1: 0.16.1+build.387-1.16
  20w30a: 0.15.2+build.382-1.16
---
