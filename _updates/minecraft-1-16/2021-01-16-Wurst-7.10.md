...
minecraft-versions:
  ...
  - "1.15.2"
fabric: true
image: https://wiki.wurstclient.net/_media/update/wurst_7.10_540p.webp
fabric-api:
...
- Added [OpenWaterESP](https://wiki.wurstclient.net/openwateresp): Shows whether or not you are fishing in 'open water' and draws a box around the area used for the open water calculation. (Minecraft 1.16+ only)

- [AutoFish](https://wiki.wurstclient.net/autofish) will now warn you if you are fishing in shallow water. (Minecraft 1.16+ only)

- Added tooltips to [AltManager](https://wiki.wurstclient.net/altmanager)'s "Import" and "Export" buttons.

- Fixed [AutoSprint](https://wiki.wurstclient.net/autosprint) not sprinting when it's raining.
