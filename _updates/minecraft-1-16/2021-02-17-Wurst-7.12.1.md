...
- Updated [X-Ray](https://wiki.wurstclient.net/x-ray)'s list of ores to include new 1.17 blocks like [copper ore](https://minecraft.gamepedia.com/Copper_Ore) and all of the deepslate ores by default. (Minecraft 21w08a+ only)
