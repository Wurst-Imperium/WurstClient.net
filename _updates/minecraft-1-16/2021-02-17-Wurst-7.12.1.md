...
- Updated BaseFinder's list of natural blocks to include new 1.17 blocks like [copper ore](https://minecraft.gamepedia.com/Copper_Ore), [amethysts](https://minecraft.gamepedia.com/Amethyst_Geode) and [grimstone](https://minecraft.gamepedia.com/Grimstone) by default.
