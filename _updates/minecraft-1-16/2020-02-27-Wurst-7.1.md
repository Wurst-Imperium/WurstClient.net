...
minecraft-versions:
  ...
  - "1.14.4"
fabric: true
image: https://wiki.wurstclient.net/_media/update/wurst_7.1_540p.webp
hacks:
  - AntiAFK
  - AntiBlind
  - AntiCactus
...
- Added [`.bind`](https://wiki.wurstclient.net/cmd/bind) and `.unbind` commands for people who are more used to that kind of syntax.
