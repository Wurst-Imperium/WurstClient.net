...
- [AutoFarm](https://wurst.wiki/autofarm) and [BonemealAura](https://wurst.wiki/bonemealaura) can now be used together to automatically farm stuff with [bone meal](https://minecraft.gamepedia.com/Bone_Meal).

- [AutoFarm](https://wurst.wiki/autofarm) can now harvest [bamboo](https://minecraft.gamepedia.com/Bamboo).
...
- Fixed Fullbright's ["Night Vision" method](https://wurst.wiki/fullbright#method) removing actual [Night Vision](https://minecraft.gamepedia.com/Night_Vision) potion effects. (Thanks to <a href="https://github.com/ThisTestUser" target="_blank">ThisTestUser</a>!)
