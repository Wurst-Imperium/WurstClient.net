...
- [AntiAFK](https://wiki.wurstclient.net/antiafk) is back!
...
- [Glide](https://wiki.wurstclient.net/glide) is back!

- Added a warning to [Glide](https://wiki.wurstclient.net/glide) saying that, unless you use NoFall, you will still take fall damage with it enabled.
...
- [MultiAura](https://wiki.wurstclient.net/multiaura) is back!
