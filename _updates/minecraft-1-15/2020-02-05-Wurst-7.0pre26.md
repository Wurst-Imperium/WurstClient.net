...
- Changed the [category](https://wiki.wurstclient.net/categories) of AutoPotion from "Other" to "Combat".
...
- [BowAimbot](https://wiki.wurstclient.net/bowaimbot) is back!

- Added a ["Priority" setting](https://wiki.wurstclient.net/bowaimbot#priority) to BowAimbot.

- Added [filters](https://wiki.wurstclient.net/bowaimbot#filter_players) to BowAimbot.
...
- Fixed [MultiAura](https://wiki.wurstclient.net/multiaura) not being disabled automatically when using other Killauras.
