...
- [ArenaBrawl](https://wurst.wiki/arenabrawl): Spielt automatisch ArenaBrawl und umgeht dabei Hypixels NoCheat. Könnte noch Bugs haben.

- GUI sieht besser aus und aktualisiert sich jetzt richtig.

- Invisibility wird im YesCheat+ Modus abgeschaltet.

- [AutoBuild](https://wurst.wiki/autobuild) umgeht NoSwing und sollte auf AntiCheat-Servern funktionieren.
