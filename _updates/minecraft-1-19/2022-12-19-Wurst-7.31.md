...
fabric-api:
  ...
  "23w04a": 0.73.1+1.19.4
  "23w03a": 0.72.1+1.19.4
---
## Changelog
...
- Added a "Filter shulker bullets" checkbox to Killaura and other combat hacks. When unchecked, these hacks can now attack shulker bullets and destroy them. ([#723](https://github.com/Wurst-Imperium/Wurst7/pull/723) - Thanks to <a href="https://github.com/bendy1234">bendy1234</a>!)
...
- Added an "Attack while blocking" checkbox to TriggerBot that lets you disable the above fix, in case you want to attack while blocking. ([#749](https://github.com/Wurst-Imperium/Wurst7/pull/749) - Thanks to <a href="https://github.com/EncryptionEnjoyer">EncryptionEnjoyer</a>!)
