...
- Added [NewChunks](https://wiki.wurstclient.net/newchunks): Highlights newly generated chunks around you. (Also includes [a lot of settings](https://wiki.wurstclient.net/newchunks#settings).)

- Added [NoLevitation](https://wiki.wurstclient.net/nolevitation): Disables the levitation effect when you get hit by a Shulker. (Thanks to <a href="https://github.com/pikami">pikami</a>!)
