...
- TemplateTool will now create better templates that [AutoBuild](https://wurst.wiki/autobuild) can build more quickly.

- `.path -debug` will now work with [AutoBuild](https://wurst.wiki/autobuild)'s pathfinder.
