...
minecraft-versions:
  ...
  - "1.8"
  - "1.8 OF"
image: https://wiki.wurstclient.net/_media/update/wurst_6.35.1_540p.webp
...
- Fixed a crash when [RemoteView](https://wiki.wurstclient.net/remoteview) can't find a nearby entity.

- Fixed [ScaffoldWalk](https://wiki.wurstclient.net/scaffoldwalk) not working in Minecraft 1.8.
