...
- Added [AutoTotem](https://wiki.wurstclient.net/autototem) (Minecraft 1.12.x only): Automatically moves totems of undying to your off-hand. (Thanks to <a href="https://github.com/andevo" target="_blank" rel="nofollow">andevo</a>!)

- Split AntiKnockback's "Strength" slider into ["Horizontal Strength"](https://wiki.wurstclient.net/antiknockback#horizontal_strength) and ["Vertical Strength"](https://wiki.wurstclient.net/antiknockback#vertical_strength). (Thanks to <a href="https://github.com/flestr" target="_blank" rel="nofollow">flestr</a>!)

- Fixed [AntiKnockback](https://wiki.wurstclient.net/antiknockback)'s description still saying that it would prevent you from getting pushed by flowing water.
